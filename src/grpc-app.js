...
const transferFlowPackage = grpcObject.transferFlow;

const server = new grpc.Server();

function helloMessage(call, callback) {
  callback(null, { hello: "hello, this is inventory-transferflow-service" });
}

const {} = require("./controllers-layer/grpc-layer");

server.addService(transferFlowPackage.transferFlowService.service, {
  helloMessage,
  ...sessionRouter,
});
