...
const { dbGetInternaltransferlog } = require("dbLayer");

class GetInternalTransferLogManager extends InternalTransferLogManager {
  ...
  async doBusiness() {
    // Call DbFunction
    // make an awaited call to the dbGetInternaltransferlog function to get the internaltransferlog and return the result to the controller
    const internaltransferlog = await dbGetInternaltransferlog(this);
...
module.exports = GetInternalTransferLogManager;
