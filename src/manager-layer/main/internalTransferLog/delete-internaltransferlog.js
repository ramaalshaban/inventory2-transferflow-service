...
const { dbDeleteInternaltransferlog } = require("dbLayer");

class DeleteInternalTransferLogManager extends InternalTransferLogManager {
  ...
  async doBusiness() {
    // Call DbFunction
    // make an awaited call to the dbDeleteInternaltransferlog function to delete the internaltransferlog and return the result to the controller
    const internaltransferlog = await dbDeleteInternaltransferlog(this);
...
module.exports = DeleteInternalTransferLogManager;
