...
const { dbDeleteInternaltransfer } = require("dbLayer");

class DeleteInternalTransferManager extends InternalTransferManager {
  ...
  async doBusiness() {
    // Call DbFunction
    // make an awaited call to the dbDeleteInternaltransfer function to delete the internaltransfer and return the result to the controller
    const internaltransfer = await dbDeleteInternaltransfer(this);
...
module.exports = DeleteInternalTransferManager;
