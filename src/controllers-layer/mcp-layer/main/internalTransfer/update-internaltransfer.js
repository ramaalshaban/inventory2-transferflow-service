...
class UpdateInternalTransferMcpController extends TransferFlowMcpController {
  constructor(params) {
    super("updateInternalTransfer", "updateinternaltransfer", params);
    this.dataName = "internalTransfer";
    this.crudType = "update";
  }

  createApiManager() {
    return new UpdateInternalTransferManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  return {
    ...
    description:
      "Update transfer (change status, details, or cancel before completion).",
    parameters: UpdateInternalTransferMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      mcpParams.headers = headers;
      const updateInternalTransferMcpController =
        new UpdateInternalTransferMcpController(mcpParams);
      try {
        const result =
          await updateInternalTransferMcpController.processRequest();
        //return UpdateInternalTransferMcpController.getOutputSchema().parse(result);
        return {
          content: [
            {
              type: "text",
