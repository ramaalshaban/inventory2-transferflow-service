...
class GetInternalTransferByStatusMcpController extends TransferFlowMcpController {
  constructor(params) {
    super("getInternalTransferByStatus", "getinternaltransferbystatus", params);
    this.dataName = "internalTransfer";
    this.crudType = "get";
  }

  createApiManager() {
    return new GetInternalTransferByStatusManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  return {
    ...
    parameters: GetInternalTransferByStatusMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      mcpParams.headers = headers;
      const getInternalTransferByStatusMcpController =
        new GetInternalTransferByStatusMcpController(mcpParams);
      try {
        const result =
          await getInternalTransferByStatusMcpController.processRequest();
        //return GetInternalTransferByStatusMcpController.getOutputSchema().parse(result);
        return {
          content: [
            {
              type: "text",
